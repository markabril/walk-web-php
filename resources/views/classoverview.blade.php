...
<div class="row topcover">
   <img class="clock" src="{{ asset('photos/transparents/pattern.png') }}">
    <div class="col-lg-6 charinfo">
       <div class=" m-5 shadowtext">
       <h2 class="mt-5 mb-4 littext"><img id="class_icon" src="{{ asset('photos/icons/swordsman.png') }}" style="width:50px; transform : scale(2);"> <span id="class_name">SWORDSMAN</span></h2>
    ...
    <div class="col-lg-6" style="height: 720px;">
        ...
        <source src="{{ asset('videos/swordsman.webm')}}" type="video/mp4">
        </video>
...
$(".charinfo").hide();
            ...
            $("#class_animation").prop("src","{{ asset('videos/') }}/" + classname + ".webm");
            $("#class_icon").prop("src","{{ asset('photos/icons/') }}/" + classname + ".png");
