  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light ">
    <div class="container">
  <a class="navbar-brand littext" href="#"><img src='{{ asset("photos/icons/icon_walkonlinesingle.png") }}' style="height: 35px; "> W<small>ALK</small> O<small>NLINE</small> M<small>OBILE</small></a>
  ...
  <div class="collapse navbar-collapse readable" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{ route('goto_story') }}"><i class="fas fa-book littext"></i> Lore</a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="{{ route('goto_news') }}"><i class="fa-solid fa-newspaper littext"></i> News</a>
</li>
