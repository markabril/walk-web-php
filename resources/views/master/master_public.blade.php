...
<head>
   ...
   <meta name="description"
      content="WALK ONLINE MOBILE is Is a free-to-play mobile Massively Multiplayer Online Role Playing Game(MMORPG). A 3d game which offers PvP, Party, Trading System and more. Players can quickly get set up to play a with other players in real time.">
   <meta name="keywords"
      content="MMORPG, Walk Online, WOM, CW, Mobile Game, Massively Multiplayer Online Role Playing Game. EGC, Extreme Unreal Technology Inc.,">
   ...
   <script type="text/javascript"
      src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.5/dist/additional-methods.js"></script>
...
<body>
   ...
   <!-- @include('comp.eventoverlay_public') -->
   ...
   <script>
      ...
      // snowStorm.snowStick = true; // Allow snowflakes to stick to the bottom
