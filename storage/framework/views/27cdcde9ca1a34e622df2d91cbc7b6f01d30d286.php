...
<script>
  ...
  function loadJob(){
      $.ajax({
        type: "get",
        url: "<?php echo e(route('stole_getjobs')); ?>",
  ...
  function addJob(){
    ...
    let data = {
     ...
     if(Object.values(data).every(val => val !== "" && val !== null)){
      $.ajax({
        type: "post",
        url: "<?php echo e(route('shoot_addjob')); ?>",
        data: formData,
        contentType: false,
      processData: false,
        success: function(data){
  ...
  function deleteJob(){
    $.ajax({
      type: "get",
      url: "<?php echo e(route('shoot_deletejob')); ?>",
  ...
  function changeStatus(control_obj){
    ...
    $.ajax({
      type: "post",
      url: "<?php echo e(route('shoot_updatejobstatus')); ?>",
      data: {_token: "<?php echo e(csrf_token()); ?>", currentId: currentId,status: status},
      success:function(data){
        say(data);
        loadJob();
      }
