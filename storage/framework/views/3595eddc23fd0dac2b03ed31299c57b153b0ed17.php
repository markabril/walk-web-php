...
$("#inp_item_description").val("");
  ...
  function deleteUpdateRecord(){
    ...
    $.ajax({
      type: "post",
      url: "<?php echo e(route('shoot_deleteupdaterec')); ?>",
      data: {_token: "<?php echo e(csrf_token()); ?>",current_updateid: current_updateid },
...
$("#pnl_addupdateitems").hide();
  ...
  function deleteFeatureItem(){
    ...
    $.ajax({
      type: "post",
      url: "<?php echo e(route('shoot_deletefeatureitem')); ?>",
      data: {_token: "<?php echo e(csrf_token()); ?>", current_itemId: current_itemId},
      success: function(data){
        say(data);
  ...
  function loadupdateItems(itemId){
    ...
    function a_getUpdateInfoById(){
      $.ajax({
        type: "get",
        url: "<?php echo e(route('stole_updatebasicinfo')); ?>",
        data: {_token: "<?php echo e(csrf_token()); ?>",itemId: itemId},
        success: function(data){
    ...
    function a_getUpdateItems(){
      $.ajax({
      type: "get",
      url: "<?php echo e(route('stole_updateitems')); ?>",
      data: {_token: "<?php echo e(csrf_token()); ?>",current_updateid: itemId},
      success: function(data){
...
if ( inp_item_cover && inp_item_title && inp_item_description){
  $.ajax({
  type: "post",
  url: "<?php echo e(route('shoot_newupdateitem')); ?>",
  data: formData,
  contentType: false,
          processData: false,
  success: function(data){
    ...
    formData.append('description',description);
      showload();
        ...
        if(newsheadline != "" && coverphoto != "" && description != "" && coverphoto != null && coverphoto != ""){
          $.ajax({
            type: "post",
            url: "<?php echo e(route('shoot_publishnews')); ?>",
            data: formData,
          contentType: false,
          processData: false,
            success: function(data){
      ...
      function loadNews(){
        localStorage.setItem("lastnewstab","news");
          ...
          $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_getallnews')); ?>",
            data: {
      ...
      function deleteNews(){
        showload();
          $.ajax({
            type: "post",
            url: "<?php echo e(route('shoot_deletenews')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>",currentnewsnumber: currentnewsnumber },
            success: function(data){
              hideload();
              say(data);
              loadNews();
      ...
      function loadUpdates(){
        ...
        $.ajax({
          type: "get",
          url: "<?php echo e(route('stole_updatesfromadmin')); ?>",
      ...
      function setupUpdateCreation(){
        ...
        if (inp_update_versionnumber && updatetitle && updatedescription && inp_update_releasedate) {
          ...
          $.ajax({
            type: "post",
            url: "<?php echo e(route('shoot_addnewupdatesetup')); ?>",
            data: formData,
            contentType: false,
          processData: false,
            success: function(data){
