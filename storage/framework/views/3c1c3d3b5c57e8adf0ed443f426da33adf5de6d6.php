 <?php $__env->startSection('title'); ?> WALK Online - Mobile MMORPG <?php $__env->stopSection(); ?> <?php $__env->startSection('contents'); ?>
<style>
	.download_img{
		height: 50px;
	}
...
<script>
	...
	function loadChapterContent(){
		...
		$.ajax({
			type: "get",
			url: "<?php echo e(route('stole_singlechaptercontpublic')); ?>",
			data: {_token: "<?php echo e(csrf_token()); ?> ", chapter: chapter},
	...
	function getChapterView(chap){
		...
		$.ajax({
            type: "GET",
            url: "<?php echo e(route('stole_getallchapterslistminimal')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>",chap: chap},
            success: function(data){
