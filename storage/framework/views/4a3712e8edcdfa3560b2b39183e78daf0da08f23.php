...
<?php echo $__env->make('comp.header_public', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	background:url(<?php echo e(asset('photos/art/egcbuilding.jpg')); ?>);
...
loadeamMembers();
	function loadeamMembers(){
		$.ajax({
			type: "get",
			url: "<?php echo e(route('stole_publicmembers')); ?>",
	...
	function loadAvailablePostedJobs(){
		$.ajax({
			type: "get",
			url: "<?php echo e(route('stole_publishedjobposting')); ?>",
			data: {_token: "<?php echo e(csrf_token()); ?>"},
			success: function(data){
	...
	function getFullJobInformation(controlObj){
		...
		$.ajax({
			type: "get",
			url: "<?php echo e(route('stole_fulljobinfo')); ?>",
