...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-9">
			<h1><?php echo ucwords(strtolower($_GET["/"])); ?></h1>
			<div class="container" style=" text-align: center; max-height: 100vh; overflow-y: scroll; overflow-x: hidden;" id="cont_flashcontent">
...
<script type="text/javascript">
	var ftype = <?php echo json_encode($_GET["/"]); ?>;
	GetFlashContent();
	function GetFlashContent(){
		$.ajax({
			type: "GET",
			url: "<?php echo e(route('stole_getflashcontent')); ?>",
			data: {_token: "<?php echo e(csrf_token()); ?>",flashtype: ftype},
			success: function(data){
				$("#cont_flashcontent").html(data);
			}
		})
	}
</script>
