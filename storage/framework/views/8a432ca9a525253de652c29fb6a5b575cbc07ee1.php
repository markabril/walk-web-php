  ...
  <div class="card" >
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <h5><?php echo e(session('user_name')); ?></h5>
                ...
                if(inp_inpnewpassword == inp_renewpassword)
{
    $.ajax({
                type: "post",
                url: "<?php echo e(route('shoot_changepassword')); ?>",
    ...
    function action_changeRole(){
          ...
          if(inp_rolenew != ""){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('shoot_changerole')); ?>",
                data: {_token: "<?php echo e(csrf_token()); ?>",inp_rolenew: inp_rolenew},
                success: function(data){
    ...
    function action_changeUsername(){
        var inp_username = $("#inp_username").val();
            $.ajax({
                type: "post",
                url: "<?php echo e(route('shoot_changeusername')); ?>",
                data: {_token: "<?php echo e(csrf_token()); ?>", inp_username: inp_username},
                success: function(data){
                    alert("Success!");
    ...
    function action_changeProfilePicture(){
          ...
          if(inp_profilepic){
            $.ajax({
                type: "post",
                url: "<?php echo e(route('shoot_changeprofilepic')); ?>",
                data: formData,
                contentType: false,
                processData: false,
                success: function(data){
    ...
    function getAccountInfoBasic(){
        $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_getmyinfobasic')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>"},
            success: function(data){
