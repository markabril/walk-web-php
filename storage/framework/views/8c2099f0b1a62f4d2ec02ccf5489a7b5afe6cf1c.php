...
<html lang="en">
  ...
  <meta name="author" content="Virmil Talattad">
      ...
      <link rel='stylesheet' href='<?php echo e(asset("css/sanitysystem.css")); ?>'>
  ...
  body{
    background-image: url('<?php echo e(asset("photos/art/fakeblur.png")); ?>') !important;
...
$(".jobposting").hide();
$(".contributors").hide();
var fset = '<?php echo e(session("user_featureset")); ?>';
if(fset != ""){
