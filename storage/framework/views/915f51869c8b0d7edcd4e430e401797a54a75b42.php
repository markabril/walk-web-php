...
<?php echo $__env->make('comp.header_public', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	background:url(<?php echo e(asset('photos/art/defender.png')); ?>);
		...
		">
			<center>
				...
				<h1 class="shadowtext" style="margin-top: 23vh; font-size: 40px;">
					<img src="<?php echo e(asset('photos/transparents/walktext.png')); ?>" class="walktext" style="width:70%; max-width:900px;" loading="lazy">
				</h1>
...
<div class="container_cover">
	...
	<img class="floaties" src="<?php echo e(asset('photos/transparents/pat1.png')); ?>" loading="lazy">
	<div class="container mt-5"  >
	
	<div class="row">
		<div class="col-md-12">
			<center>
			<img src="<?php echo e(asset('photos/icons/icon_walkonlinesingle.png')); ?>" class="mb-5" alt="wlogo" border="0">

			<p><img src="<?php echo e(asset('photos/transparents/walkphone.png')); ?>" loading="lazy" style="width:90%;"></p>
...
BuraotGaming2
<br>
<img loading="lazy" src="<?php echo e(asset('photos/icons/sm_ne.png')); ?>" style="width: 50px; margin-bottom: -30px;">
</h6>
</center>
</div>
	</div>
...
SELECTiON
<br>
<img loading="lazy" src="<?php echo e(asset('photos/icons/sm_fe.png')); ?>" style="width: 33px; margin-bottom: -30px;">
</h6>
</center>
</div>
	</div>
...
BOSS
<br>
<img loading="lazy" src="<?php echo e(asset('photos/icons/sm_peli.png')); ?>" style="width: 40px; margin-bottom: -30px;">
</h6>
</center>
</div>
	</div>
...
<div style="
width: 100%; 
background-image: url(<?php echo e(asset('photos/poster/tutorials.jpg')); ?>);
background-size:cover;
background-repeat: no-repeat;
">
		...
		<div class="col-sm-6">
				...
				<div class="card card-simple" style="margin: auto;">
					<div class="card-body">
						<div class="row">
					<div class="col-sm-4">
							<img src="<?php echo e(asset('photos/poster/walklogo.png')); ?>" loading="lazy" style="width:100%; border-radius: 5px;">
					</div>
					<div class="col-sm-8">
							<div class="mt-4 mb-4">
		...
		<div class="col-sm-6">
				...
				<div class="card card-simple" style="margin: auto; ">
					<div class="card-body">
						<div class="row">
					<div class="col-sm-4">
							<img src="<?php echo e(asset('photos/poster/walkmerch.png')); ?>" loading="lazy" style="width:100%; border-radius: 5px;">
					</div>
					<div class="col-sm-8">
							<div class="mt-4 mb-4">
