...
background: linear-gradient(180deg, rgba(0,0,0,0) 0%, #16232F 100%);
		">
			<center>
					...
					<img src="<?php echo e(asset('photos/transparents/walklogofull.png')); ?>" class="walktext" loading="lazy">
...
<span id="deat_desc">See all the new features behind this masterpice! See all the new features behind this masterpice! See all the new features behind this masterpice!</span></p>
	<a class="btn btn-primary" target="_blank" href="#" id="feat_button">Explore</a>
		...
		<div class="col-sm-3">
		<h5><small><a class="text-light" href="<?php echo e(route('goto_news')); ?>">NEWS & UPDATES</a></small></h5>
		...
		<div class="col-md-12" style="margin-bottom:100px;">
			...
			<div class="card-deck">
				...
				<div class="card card-simple">
					<div class="card-body">
							<center>
								<img loading="lazy" src="<?php echo e(asset('photos/icons/ne.png')); ?>" style="height: 150px;">
				...
				<div class="card card-simple" >
					<div class="card-body">
							<center>
								<img loading="lazy" src="<?php echo e(asset('photos/icons/fe.png')); ?>" style="height: 150px;">
				...
				<div class="card card-simple">
					<div class="card-body">
							<center>
								<img loading="lazy" src="<?php echo e(asset('photos/icons/peli.png')); ?>" style="height: 150px;">
...
background-image : url('<?php echo e(asset('photos/poster/flagger.png')); ?>') !important;
margin-bottom:100px;
...
<span id="ph_ne"></span>
<br>
<img loading="lazy" src="<?php echo e(asset('photos/icons/sm_ne.png')); ?>" style="width: 50px; margin-bottom: -18px;">
</small>
</center>
</div>
	</div>
...
<span id="ph_fe"></span>
<br>
<img loading="lazy" src="<?php echo e(asset('photos/icons/sm_fe.png')); ?>" style="width: 33px; margin-bottom: -18px;">
</small>
</center>
</div>
	</div>
...
<br>
<img loading="lazy" src="<?php echo e(asset('photos/icons/sm_peli.png')); ?>" style="width: 40px; margin-bottom: -18px;">
</small>
</center>
</div>
	</div>
...
<div class="separator-gold-center mb-2 mt-3"></div>
	...
	<small><a href="<?php echo e(route('goto_hackwinners')); ?>"><i class="fa-solid fa-arrow-right"></i> Hackathon Champions Legacy</a></small>
</center>
</div>
	...
	<div class="row">
		...
		<div class="col-md-12" >
			<div class="row" >
				...
				<div style='transform:rotatey(30deg) rotatex(10deg); background-image: url(<?php echo e(asset('photos/transparents/ff_swordsman.png')); ?>)' class="char_holder">
			
			<a  href="<?php echo e(route('goto_classoverview')); ?>?selected=swordsman">
			...
			<img class="charcard_icon" style="height:30px; transform: scale(5);" src="<?php echo e(asset('photos/icons/swordsman.png')); ?>" alt="swordsman" border="0">
				...
				<div class="col-md-3" style="perspective: 1000px;">
				<div   style='transform:rotatey(30deg)  rotatex(10deg); background-image: url(<?php echo e(asset('photos/transparents/ff_shaman.png')); ?>)' class="char_holder">
				
				<a  href="<?php echo e(route('goto_classoverview')); ?>?selected=shaman">
				<div class="bg_separator">
			<img class="charcard_icon" style="height:30px; transform: scale(5);" src="<?php echo e(asset('photos/icons/shaman.png')); ?>" alt="swordsman" border="0">
				...
				<div class="col-md-3" style="perspective: 1000px;">
				<div style='transform:rotatey(-30deg)  rotatex(10deg); background-image: url(<?php echo e(asset('photos/transparents/ff_brawler.png')); ?>)' class="char_holder">
				<a  href="<?php echo e(route('goto_classoverview')); ?>?selected=brawler">
				<div class="bg_separator">
			<img class="charcard_icon" style="height:30px; transform: scale(5);" src="<?php echo e(asset('photos/icons/brawler.png')); ?>" alt="swordsman" border="0">
				...
				<div class="col-md-3" style="perspective: 1000px;">
				<div   style='transform:rotatey(-30deg)  rotatex(10deg); background-image: url(<?php echo e(asset('photos/transparents/ff_archer.png')); ?>)' class="char_holder">
				<a  href="<?php echo e(route('goto_classoverview')); ?>?selected=archer">
				<div class="bg_separator">
...
<div class="modal" tabindex="-1" role="dialog" id="mdl_swordsman">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <div class="row">
			  		<div class="col-md-4">
			  			<div style='background-image: url(<?php echo e(asset('photos/transparents/ff_swordsman.png')); ?>)' class="char_holder">
			  			</div>
			  		</div>
			  		<div class="col-md-8">
...
<div class="modal" tabindex="-1" role="dialog" id="mdl_shaman">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <div class="row">
			  		<div class="col-md-4">
			  			<div style='background-image: url(<?php echo e(asset('photos/transparents/ff_shaman.png')); ?>)' class="char_holder">
...
<div class="modal" tabindex="-1" role="dialog" id="mdl_brawler">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <div class="row">
			  		<div class="col-md-4">
			  			<div style='background-image: url(<?php echo e(asset('photos/transparents/ff_brawler.png')); ?>)' class="char_holder">
...
<div class="modal" tabindex="-1" role="dialog" id="mdl_archer">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <div class="row">
			    		<div class="col-md-4">
			    			<div style='background-image: url(<?php echo e(asset('photos/transparents/ff_archer.png')); ?>)' class="char_holder">
			    			</div>
			    		</div>
			    		<div class="col-md-8">
			    		<div class="card card-primary mb-3"><div class="card-body">	<small class="littext">DESCRIPTION</small>
...
<script>
    ...
    return $.ajax({
        type: "get",
        url: "<?php echo e(route('stole_homecoverphoto')); ?>",
    ...
    .then(function(data) {
        ...
        return $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_homehackathonwinners')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>"},
        });
    })
	.then(function(data) {
...
if(data.length  != 0){
	...
	$("#lbl_hackdate, #ph_ne, #ph_fe, #ph_peli, #int_ne, #int_fe, #int_peli, #hackmessage ").html("(n/a)");
        ...
        return $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_latestnews')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>"},
        });
    })
	...
	.then(function(data) {
        ...
        return $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_homefeatured')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>"},
        });
    })
    .then(function(data) {
...
$("#feat_button").prop("href","#");
        ...
        return $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_homefeatures')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>"},
        });
    })
    .then(function(data) {
        ...
        return $.ajax({
            type: "get",
            url: "<?php echo e(route('stole_homebottompanel')); ?>",
            data: {_token: "<?php echo e(csrf_token()); ?>"},
        });
    })
    .then(function(data) {
