...
if(data[0]["eid_sign_hr"] == "n/a" ||  data[0]["eid_sign_recommending"] == "n/a" ||  data[0]["eid_sign_approval"] == "n/a"){
isvalid = false;
}
...
$("#btn_applyleave").show();
						...
						$("#warningspan").html("<div class='alert alert-warning' role='alert'>Please make sure that you set your department on your profile page before you apply for leave.</div>");
