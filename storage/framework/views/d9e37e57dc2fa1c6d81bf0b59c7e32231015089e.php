...
<html lang="en">
  ...
  <meta name="author" content="Virmil and Renz">
      ...
      <link rel="icon" type="image/x-icon" href="<?php echo e(asset('images/pr.png ')); ?>">
      <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6288422486031701"
     crossorigin="anonymous"></script>
      <link rel='stylesheet' href='<?php echo e(asset("css/sanity.css")); ?>'>
    <!-- cdnjs -->
    <script type="text/javascript" src="<?php echo e(asset('jlazy/jquery.lazy.min.js')); ?>"></script>     
   </head>
   <body>
         <?php echo $__env->yieldContent('contents'); ?>
<script type='text/javascript' src='//pl17175866.safestgatetocontent.com/fb/09/3b/fb093beb24e871e92af5b53d053cab73.js'></script>
