...
function getAvailableBottomInfo(){
  ...
  $.ajax({
    type: "get",
    url: "<?php echo e(route('stole_getbottomsingleinfo')); ?>",
    data: {_token: "<?php echo e(csrf_token()); ?>",conttype: inputBottomMode},
...
function loadBottomPanels(){
  $.ajax({
    type: "get",
    url: "<?php echo e(route('stole_getbottominfopnl')); ?>",
...
$("#inp_bp_link").val() != "" && $("#inp_bp_btnname").val() != ""
  ...
  $.ajax({
    type: "post",
    url: "<?php echo e(route('shoot_updateabottompnl')); ?>",
    data: formData,
    contentType: false,
    processData: false,
    success : function(data){
...
function deleteFeature(){
  showload();
    $.ajax({
      type: "get",
      url: "<?php echo e(route('shoot_deletefeature')); ?>",
      data: {_token: "<?php echo e(csrf_token()); ?>","featid": currFeatureId},
      success: function(data){
        hideload();
...
if ( $('#coverFile')[0].files[0] != null &&  $('#coverFile')[0].files[0] != ""){
  let formData = new FormData();
    ...
    $.ajax({
        url: "<?php echo e(route('shoot_uploadhomecover')); ?>",
        type: 'post',
        data: formData,
        contentType: false,
        processData: false,
...
function getLatestFeatured(sequenced = false){
  showload();
    $.ajax({
        url : "<?php echo e(route('stole_latestfeatured')); ?>",
        type: "get",
        data : {_token: "<?php echo e(csrf_token()); ?>"},
        success: function (data){
          hideload();
...
function getLatestCover(sequenced = false){
  showload();
    $.ajax({
        url : "<?php echo e(route('stole_latestCoverPhoto')); ?>",
        type: "get",
        data : {_token: "<?php echo e(csrf_token()); ?>"},
        success: function (data){
          hideload();
...
function addNewFeatureData(){
  ...
  if(fftitle != "" && ffdesc != "" && ffimg != ""){
    ...
    showload();
    $.ajax({
      url: "<?php echo e(route('shoot_addnefeature')); ?>",
      type: 'post',
        data: formData,
        contentType: false,
        processData: false,
...
function showAllFeatures(sequenced = false){
  ...
  $.ajax({
    type: "get",
    url: "<?php echo e(route('stole_addedfeatures')); ?>",
    data: {_token: "<?php echo e(csrf_token()); ?>"},
    success: function(data){
